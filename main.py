...
if __name__ == '__main__':
    ...
    average_uploadtime_ms = test_data.totalUploadTime / (float)(number_of_block) *1000.0
    average_downloadtime_ms = test_data.totalDownloadTime / (float)(number_of_block)*1000.0
